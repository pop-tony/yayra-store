              ...
              <div className="space-y-4 text-zinc-600 dark:text-zinc-400">
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <a href="mailto:support@marketplace.com" className="hover:text-rose-500">support@marketplace.com</a>
                  </div>
                </div>
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <a href="tel:+233555123456" className="hover:text-rose-500">+233 55 512 3456</a>
                  </div>
                </div>
                <div className="flex items-start gap-3">
